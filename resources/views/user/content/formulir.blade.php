                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="string" name="place" class="form-control" id="tp2"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 p-0">
                                        <input type="number" name="jml_saudara" class="form-control input-full"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="kerja_ayah" class="form-control" id="krjyh"
                                        placeholder="...">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="pend_akhira" class="form-control" id="pdtrkh"
                                        placeholder="...">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="no_telpayah" class="form-control" id="nohape"
                                        placeholder="...">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="pend_akhiri" class="form-control" id="pdibu"
                                        placeholder="...">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="no_telpibu" class="form-control" id="nohapeibu"
                                        placeholder="...">
